...
curl -c cookies.txt $URL"/api/auth/login/stephen@augurworks.com/7msCYOF1lJ3aoclnjbV6KH1I9P2Xn5ht42IQx9JaRRo%3D" > response.txt
echo ""
echo ""
...
curl -b cookies.txt $URL"/api/social/person/get" >> response.txt
echo ""
echo ""


# Log out
curl -b cookies.txt $URL"/api/auth/logout" >> response.txt
echo ""
echo ""
